...
### About
- 유명한 오픈소스 웹 프로젝트인 ["The Odin Project"](https://www.theodinproject.com/)의 [첫 번째 과제](project)이다. 아주 간단한 웹 페이지를 만들고 링크로 연결해본다.
...
- `<ul>` 태그와 `<ol>` 태그를 구분하여 리스트를 작성할 수 있다.
- Telescope을 사용하여 Git braches를 전환하며 로컬 작업할 수 있다.
